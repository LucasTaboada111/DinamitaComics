...
const DataTableTemplatingDemo = () => {
  ...
  const quantityBodyTemplate = () => {
    return (
      <div style={{ display: "flex" }}>
        <Button className={styles.boton} icon="pi pi-plus"></Button> <h6>0</h6>
  ...
  const footer= <div className={styles.divFooter} > <Button icon="pi pi-wallet" className={styles.buttonBuy} style={{width:'20%',margin:'0 auto'}}> Buy Cart</Button></div> 
